...
public class DateUtils extends org.apache.commons.lang.time.DateUtils {
	...
	public static final SimpleDateFormat HM_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm");
	/**
	 * 根据日期格式字符串解析日期字符串
	 * 
	 * @param str
	 ...
	 * @return
	 */
	public static String getHMTimeStr(Date time) {
		return HM_FORMAT.format(time);
	}
